...
```
    ...
    ## Time difference of 5.4673 secs
...
```
    ...
    ##         a field.x                                                      b field.y
    ##     <dbl> <chr>                                                    <dbl> <chr>  
    ##  1 144814 henry county republican headquarters                    1.26e6 martin…
    ##  2 385156 stone communications                                    8.88e5 zone c…
    ##  3  69774 communications workers of america local 9408            8.77e5 commun…
    ##  4  57872 texans for senator john cornyn inc.                     9.24e5 texans…
    ##  5 326086 hausman holdings ltd                                    8.80e5 hausma…
    ##  6 259059 darke county democratic women                           1.07e6 toole …
    ##  7  63036 service employees international union local 614         9.36e5 servic…
    ##  8 310938 rs & associates inc                                     1.21e6 ross &…
    ##  9  59678 international brotherhood of electrical workers local … 9.60e5 intern…
    ## 10 120877 s & g concrete                                          1.21e6 s & g …
    ## # ℹ 190,933 more rows
