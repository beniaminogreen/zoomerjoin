...
```
    ...
    ## Time difference of 5.977676 secs
...
```
    ...
    ##         a field.x                                                      b field.y
    ##     <dbl> <chr>                                                    <dbl> <chr>  
    ##  1 174013 intl union of operating engineers local 4 social        9.59e5 intl u…
    ##  2  61410 international brotherhood of electrical workers local … 9.60e5 intern…
    ##  3  39238 electrical workers local 112                            1.15e6 electr…
    ##  4 357950 service employees international union cmte on politica… 1.06e6 servic…
    ##  5 275829 j enterprises                                           1.12e6 me ent…
    ##  6 104670 plumbers & pipefitters local 506                        1.10e6 plumbe…
    ##  7 321624 ia construction corp                                    9.88e5 cci co…
    ##  8 102911 hostmark management group                               1.14e6 hostma…
    ##  9  50557 pinnacle anesthesia consultants p.a.                    8.61e5 pinnac…
    ## 10 145209 hampton county democratic party                         1.24e6 newton…
    ## # ℹ 190,933 more rows
