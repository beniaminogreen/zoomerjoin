...
```
    ...
    ## Time difference of 8.272016 secs
...
```
    ...
    ##         a field.x                                                      b field.y
    ##     <dbl> <chr>                                                    <dbl> <chr>  
    ##  1 472455 r u enterprises incorporated                            1.10e6 ptc en…
    ##  2 386321 service employees local 1100                            1.21e6 servic…
    ##  3  52266 international brotherhood of electrical workers local … 9.60e5 intern…
    ##  4  51347 taxpayers for bob huff for senate 2012                  8.92e5 taxpay…
    ##  5 332339 gavin family limited partnership                        1.11e6 zarin …
    ##  6 275650 jnb properties llc                                      1.11e6 wob pr…
    ##  7  61887 committee to re elect brian conley                      9.28e5 commit…
    ##  8 149123 electrical workers local 141                            1.11e6 electr…
    ##  9  80806 plumbers & pipefitters local 63                         8.67e5 ua plu…
    ## 10 232490 h&h construction llc                                    1.19e6 tc con…
    ## # ℹ 180,388 more rows
