...
```
    ...
    ## Time difference of 7.732785 secs
...
```
    ...
    ##         a field.x                                                      b field.y
    ##     <dbl> <chr>                                                    <dbl> <chr>  
    ##  1 317868 jfj development corp                                    1.10e6 qr dev…
    ##  2  68835 int l union of elevator constructors local 18           8.62e5 int l …
    ##  3  60287 american electric power co. texas committee for respon… 8.52e5 the am…
    ##  4  57869 texas and southwestern cattle raisers association,      9.34e5 texas …
    ##  5 285196 bell funeral home                                       1.08e6 powell…
    ##  6 171774 plumbers & pipefitters local 400                        1.23e6 plumbe…
    ##  7 276604 ind coalition of educators sponsored by the ca associa… 9.60e5 indep …
    ##  8 215147 power pac of luminant holding company                   8.72e5 power …
    ##  9 299768 decatur finance                                         1.15e6 decatu…
    ## 10 314592 mays property management co                             9.37e5 sa pro…
    ## # ℹ 177,781 more rows
