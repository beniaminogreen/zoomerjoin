...
an optimized, performant implimentation of the
...
other settings. the `jaccard_hyper_grid_search,` and `jaacrd_curve` functions
...
Jaccard similarity of greater than .8 are amost always compared (giving a low
false-negative rate).

For more details about the hyperparameters, the `textreuse` package has an
excellent vignette, and zoomerjoin provides a re-implimentation of its
...
observations, which are each assinged a label. The community-detection
