...
For this demonstration, I create a simulated dataset of 10^6 points distributed
...
Zoomerjoin is able to easily find all pairs in just under 30s, even though the
points lie in high-dimensional (d=100) space. This makes zoomerjoin a useful
tool when trying to join or find matches between datasets of word or document
embeddings.
