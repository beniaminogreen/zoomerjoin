...
- [`jaccard_left_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/jaccard-joins.md)
- [`jaccard_right_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/jaccard-joins.md)
...
- [`euclidean_left_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/euclidean-joins.md)
- [`euclidean_right_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/euclidean-joins.md)
- [`euclidean_inner_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/euclidean-joins.md)
- [`euclidean_full_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/euclidean-joins.md)
...
[`jaccard_inner_join()`](https://beniaminogreen.github.io/zoomerjoin/reference/jaccard-joins.md)
merge two lists of political donors in the [Database on Ideology, Money
in Politics, and Elections (DIME)](https://data.stanford.edu/dime). You
can see a more detailed example of this vignette in the [introductory
...
``` R
## Warning in join_func(a = a, b = b, by_a = by_a, by_b = by_b, block_by_a = block_by_a, : A pair of records at the threshold (0.7) have only a 92% chance of being compared.
...
``` R
## Time difference of 0.06295514 secs
```
...
##        a field.x                                                      b field.y 
##    <dbl> <chr>                                                    <dbl> <chr>   
##  1    87 kentucky state democratic central executive committee      639 arizona…
##  2    45 dole for senate committee                                  623 riegle …
##  3   292 bill bradley for u s senate '84                            913 bill br…
##  4   163 davies county republican executive committee               852 warren …
##  5   387 committee to re elect congressman staton                   805 committ…
##  6    35 solarz for congress 82                                     671 solarz …
...
##  9   230 pipefitters local union 524                                998 pipefit…
## 10   378 guarini for congress 1982                                  883 guarini…
## 11   122 tarrant county republican victory fund                     761 lake co…
## 12    88 scheuer for congress 1980                                  667 scheuer…
## 13   378 guarini for congress 1982                                  606 guarini…
## 14   302 americans for good government inc                          910 america…
## 15   478 united democrats for better government                     642 democra…
## 16   216 kent county republican finance committee                   607 lake co…
## 17   238 4th congressional district democratic party                518 16th co…
## 18   232 republican county committee of chester county              710 republi…
## 19   238 4th congressional district democratic party                792 8th con…
```
