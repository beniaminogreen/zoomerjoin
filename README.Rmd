...
aware that you will have to have Cargo (the rust compiler) installed to build
...
in the [guided tour vignette](https://beniamino.org/zoomerjoin/articles/guided_tour.html).
