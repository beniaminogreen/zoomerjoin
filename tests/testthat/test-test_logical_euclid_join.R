test_that("euclidian_join_core works on toy datasets", {
    capture_messages({
        ...
        inner_join_out <- euclidian_inner_join(X_1, X_2, threshold =.00005)
        ...
        left_join_out <- euclidian_left_join(X_1, X_2, threshold =.000005, band_width = 1)
        ...
        right_join_out <- euclidian_right_join(X_1, X_2, threshold =.00005)
        ...
        outer_join_out <- euclidian_anti_join(X_1, X_2, threshold =.00005)
        ...
        full_join_out <- euclidian_full_join(X_1, X_2, threshold =.00005)
